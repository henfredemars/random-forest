...
-- Path compatibility for loading modules

print("Fixing up PATH and CPATH. If you have issues with your modules, then you probably need to update these for your system")
